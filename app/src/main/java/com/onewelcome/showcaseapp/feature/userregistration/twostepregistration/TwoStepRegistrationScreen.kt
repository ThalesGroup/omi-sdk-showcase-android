...
fun TwoStepRegistrationScreen(
  ...
  TwoStepRegistrationScreenContent(
    ...
    onNavigateToTwoStepVerificationScreen = { navController.navigate(Screens.TwoStepVerification.route) },
...
fun TwoStepRegistrationScreenContent(
  ...
  ListenForNavigationEvents(navigationEvents, onNavigateToPinScreen, onNavigateToTwoStepInputScreen)
  SdkFeatureScreen(
